...
import classes from '../assets/css/ProductReview.module.css';
...
const ProductPreview = props => {
  ...
  return (
    <div className={classes.productPreview}>
      <img id="preview" src="https://imgur.com/iOeUBV7.png" alt="" /> 
      <svg
        className={classes.stoneWatchLogo}
        width="92"
        height="24"
        viewBox="0 0 92 24"
        fill="none"
      ...
      <div className={classes.watchHour}>
